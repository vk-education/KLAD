...
public class NavHeaderBindingImpl extends NavHeaderBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.userAvatar, 2);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.nickname == variableId) {
            setNickname((java.lang.String) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setNickname(@Nullable java.lang.String Nickname) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String nickname = mNickname;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.nickProfile, nickname);
        }
    }
